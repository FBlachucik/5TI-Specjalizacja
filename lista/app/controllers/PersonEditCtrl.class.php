...
class PersonEditCtrl {
	...
	public function validateSave() {
		...
		$this->form->ph_number = getFromRequest('ph_number',true,'Błędne wywołanie aplikacji');
		...
		if (empty(trim($this->form->ph_number))) {
	...
	public function action_personEdit(){
		...
		if ( $this->validateEdit() ){
			try {
				...
				$this->form->ph_number = $record['ph_number'];
